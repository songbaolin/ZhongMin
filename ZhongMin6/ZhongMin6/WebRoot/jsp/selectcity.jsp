...
<html>
  ...
  <div><input id="btnExport" type="button" value="导出表单数据"/></div>
  					...
  					请选择你要查询的城市：
   					...
   					<input type="text" name="city"  id="city" value="阜阳"/>
	...
	<script type="text/javascript">
        ...
        function reloadgrid() {  
           ...
           /*  alert(test); */
            ...
            $('#dg').datagrid({  
                url:"${pageContext.request.contextPath}/user/selectcity.action?test=" + test  
            })  
		...
		$("#dg").datagrid({
			url : "${pageContext.request.contextPath}/user/selectcity.action?time="+new Date().getTime(),
			columns:[[  
