    ...
    <div id="autoOrder">
      <div id="autoOrderC">
        ...
        <script type="text/javascript" src="${pageContext.request.contextPath}/Carmobile/js/cartype.js"></script>
               <form action="" method="post" name="form" id="form" onsubmit="return ZtBMUser();">
          <input name="UnionID" id="UnionID" value="27" type="hidden">
          <div class="input-txt mt-10">
            <input id="realname" name="realname" placeholder="请输入您的姓名" type="search">
          </div>
          <div class="input-txt">
            <input name="mp" id="mp" placeholder="请输入您的手机号码" type="search">
          </div>
          ...
          <div class="input-txt mt-10">
            ...
            <input placeholder="门票详细快递地址及备注" name="remark" id="remark" type="search">
          </div>
          <div class="input-txt">
